...
export function updateRoleById(roleId, data) {
  return request({
    url: '/api/auth/role/update/' + roleId,
    method: 'patch',
    data
  })
}
...
export function getRoleMenusById(roleId) {
  return request({
    url: '/api/auth/role/menus/get/' + roleId,
    method: 'get'
  })
}
...
export function updateRoleMenusById(roleId, data) {
  return request({
    url: '/api/auth/role/menus/update/' + roleId,
    method: 'patch',
    data
  })
}
...
export function getRoleApisById(roleId) {
  return request({
    url: '/api/auth/role/apis/get/' + roleId,
    method: 'get'
  })
}
...
export function updateRoleApisById(roleId, data) {
  return request({
    url: '/api/auth/role/apis/update/' + roleId,
    method: 'patch',
    data
  })
}
...
export function batchDeleteRoleByIds(data) {
  return request({
    url: '/api/auth/role/delete/batch',
    method: 'delete',
    data
  })
}
