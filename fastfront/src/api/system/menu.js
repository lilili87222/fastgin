...
export function batchDeleteMenuByIds(data) {
  return request({
    url: '/api/auth/menu/delete/batch',
    method: 'delete',
    data
  })
}
...
export function getUserMenusByUserId(Id) {
  return request({
    url: '/api/auth/menu/access/list/' + Id,
    method: 'get'
  })
}
...
export function getUserMenuTreeByUserId(Id) {
  return request({
    url: '/api/auth/menu/access/tree/' + Id,
    method: 'get'
  })
}
