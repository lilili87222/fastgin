...
// 获取操作日志列表
func (s LogService) GetOperationLogs(req *request.OperationLogListRequest) ([]sys.OperationLog, int64, error) {
...
// 保存操作日志到数据库
func (s LogService) SaveOperationLogChannel(olc <-chan *sys.OperationLog) {
